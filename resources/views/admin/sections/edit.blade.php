...
<div class="px-4 pt-5 pb-10">
    ...
    <div class="max-w-xl">
        <div class="rounded-2xl bg-white border border-slate-100 shadow-sm overflow-hidden">
            ...
            <form method="POST" action="{{ route('admin.learning-schemas.sections.update', [$learningSchema, $section]) }}" class="px-5 py-5 space-y-4">
                @csrf @method('PUT')
                @include('admin.sections._form', ['section' => $section, 'nextOrder' => $section->section_order])
