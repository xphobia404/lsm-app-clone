            ...
            <div class="rounded-2xl bg-white border border-slate-100 shadow-sm hover:shadow-md transition">
                <div class="flex items-start gap-3 px-4 py-3.5">
                    ...
                    <div class="flex-1 min-w-0">
                        ...
                        @endif
                        {{-- Materi yang menggunakan section ini --}}
                    ...
                    <div class="flex shrink-0 flex-col gap-1.5">
                        ...
                        <form method="POST" action="{{ route('admin.sections.toggle-active', $section) }}">
                            @csrf
                            <button type="submit"
                                class="inline-flex w-full items-center justify-center gap-1 rounded-full px-3 py-1.5 text-xs font-semibold transition
                        ...
                        <form method="POST" action="{{ route('admin.sections.destroy', $section) }}"
                            ...
                            @csrf @method('DELETE')
                            <button type="submit"
                                class="inline-flex w-full items-center justify-center gap-1 rounded-full bg-red-50 px-3 py-1.5 text-xs font-semibold text-red-500 hover:bg-red-100 transition">
