    ...
    <div class="max-w-xl">
        <div class="rounded-2xl bg-white border border-slate-100 shadow-sm overflow-hidden">
            <div class="px-5 py-4 border-b border-slate-100">
                ...
                <p class="text-xs text-slate-400 mt-0.5">Section bisa dihubungkan ke banyak materi sekaligus</p>
            </div>
            <form method="POST" action="{{ route('admin.sections.store') }}" class="px-5 py-5 space-y-4">
                @csrf
