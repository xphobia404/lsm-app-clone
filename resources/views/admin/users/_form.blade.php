<form method="POST" action="{{ $action }}" class="space-y-4">
    ...
    <div class="space-y-1">
        ...
        <select name="role"
            class="w-full rounded-xl border border-slate-200 bg-white px-4 py-2.5 text-sm text-slate-800 shadow-sm focus:border-indigo-400 focus:outline-none focus:ring-2 focus:ring-indigo-200 @error('role') border-red-400 bg-red-50 @enderror">
