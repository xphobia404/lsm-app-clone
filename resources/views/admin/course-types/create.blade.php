<x-admin-layout title="Tambah Spesialisasi">
<div class="px-4 pt-5 pb-10">
    <div class="mb-4 flex items-center gap-2">
        ...
        <div class="flex items-center gap-1.5">
            ...
            <h2 class="text-base font-bold text-slate-800">Tambah Spesialisasi</h2>
        </div>
    </div>
    <form method="POST" action="{{ route('admin.course-types.store') }}" class="space-y-4">
        @csrf
        @include('admin.course-types._form', ['courseType' => null])
