    ...
    <nav class="bottom-nav fixed bottom-0 left-0 right-0 z-50 bg-white border-t border-slate-200 shadow-lg">
        <div class="flex items-center justify-around px-2 pt-2">
            ...
            <a href="{{ route('admin.learning-schemas.index') }}"
                class="nav-item {{ request()->routeIs('admin.learning-schemas.index') || request()->routeIs('admin.learning-schemas.create') || request()->routeIs('admin.learning-schemas.edit') || request()->routeIs('admin.learning-schemas.show') ? 'active' : '' }} flex flex-col items-center gap-0.5 px-3 py-1.5 rounded-xl transition active:bg-slate-100">
                <svg class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                    <path stroke-linecap="round" stroke-linejoin="round"
            ...
            <a href="{{ route('admin.sections.index') }}"
                class="nav-item {{ request()->routeIs('admin.sections.index') || request()->routeIs('admin.learning-schemas.sections.*') ? 'active' : '' }} flex flex-col items-center gap-0.5 px-3 py-1.5 rounded-xl transition active:bg-slate-100">
                <svg class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                    <path stroke-linecap="round" stroke-linejoin="round"
