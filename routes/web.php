...
Route::middleware(['auth', 'role:admin'])
    ...
    ->group(function () {
        ...
        Route::put('learning-schemas/{learningSchema}/sections/reorder',
            [SectionController::class, 'reorder'])->name('learning-schemas.sections.reorder');
        ...
        Route::put('sections/{section}/contents/reorder',
            [ContentController::class, 'reorder']
        )->name('sections.contents.reorder');
